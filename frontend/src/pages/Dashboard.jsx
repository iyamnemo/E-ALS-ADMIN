...
const Dashboard = () => {
  ...
  const ACTIVITY_LOG_ENDPOINT = 'http://localhost:3001/api/activity-log/teachers';
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      setError(null);
      try {
        const studentResponse = await fetch('http://localhost:3001/api/students/count');
        ...
        const teacherResponse = await fetch('http://localhost:3001/api/teachers/count');
